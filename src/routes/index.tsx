...
function Index() {
  return (
    <main className="bg-background text-foreground overflow-x-hidden">
      ...
      {/* SOBRE ELI */}
      <section id="sobre" className="py-28 md:py-40 px-6 bg-background">
        <div className="max-w-6xl mx-auto grid md:grid-cols-[1fr_1.2fr] gap-16 md:gap-20 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <div className="mt-10 flex flex-wrap gap-8 text-sm">
              ...
              <div className="w-px bg-border" />
              <div>
                <p className="font-serif text-3xl text-[color:var(--gold)]">PT</p>
      ...
      {/* EXPERIÊNCIAS */}
      <section id="experiencias" className="py-28 md:py-36 px-6 bg-sand">
      ...
      {/* CURADORIA */}
      <section id="curadoria" className="py-28 md:py-36 px-6 bg-background">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-center mb-20">
            <SectionHeading
      ...
      {/* CONTATO */}
      <section id="contato" className="relative py-32 md:py-44 px-6 bg-navy overflow-hidden">
